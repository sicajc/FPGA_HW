...
HD_PWD='C:/Users/User/Desktop/FPGA_HW/final/Polish Notation/Polish Notation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PN.tcl
