...
HD_PWD='C:/Users/eee/Desktop/FPGA_HW/Week7/snake_vga/snake_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snake_vga.tcl -notrace
