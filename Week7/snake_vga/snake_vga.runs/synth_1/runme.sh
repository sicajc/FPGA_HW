...
HD_PWD='C:/Users/eee/Desktop/FPGA_HW/Week7/snake_vga/snake_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_vga.tcl
